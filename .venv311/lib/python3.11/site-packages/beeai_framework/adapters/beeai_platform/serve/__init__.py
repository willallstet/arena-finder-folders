...
import beeai_framework.adapters.agentstack.serve as _new_module

warnings.warn(
    "beeai_framework.adapters.beeai_platform.serve is deprecated and will be removed in a future release. "
    "Please use beeai_framework.adapters.agentstack.serve instead.",
    DeprecationWarning,
    stacklevel=2,
)
