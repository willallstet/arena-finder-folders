...
import beeai_framework.adapters.agentstack.context as _new_module

warnings.warn(
    "beeai_framework.adapters.beeai_platform.context is deprecated and will be removed in a future release. "
    "Please use beeai_framework.adapters.agentstack.context instead.",
    DeprecationWarning,
    stacklevel=2,
)
