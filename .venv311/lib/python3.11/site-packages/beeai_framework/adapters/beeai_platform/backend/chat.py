...
import beeai_framework.adapters.agentstack.backend.chat as _new_module

warnings.warn(
    "beeai_framework.adapters.beeai_platform.backend.chat is deprecated and will be removed in a future release. "
    "Please use beeai_framework.adapters.agentstack.backend.chat instead.",
    DeprecationWarning,
    stacklevel=2,
)
