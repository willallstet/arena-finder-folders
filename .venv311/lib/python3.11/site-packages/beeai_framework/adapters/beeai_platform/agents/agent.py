...
import beeai_framework.adapters.agentstack.agents.agent as _new_module

warnings.warn(
    "beeai_framework.adapters.beeai_platform.agents.agent is deprecated and will be removed in a future release. "
    "Please use beeai_framework.adapters.agentstack.agents.agent instead.",
    DeprecationWarning,
    stacklevel=2,
)
